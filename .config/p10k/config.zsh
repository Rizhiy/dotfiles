# Generated by Powerlevel10k configuration wizard on 2021-09-15 at 01:17 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND="green"
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND="blue"
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND="red"
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND="blue"
